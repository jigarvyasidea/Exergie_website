      ...
      <section id="about" className={classes.aboutSec}>
        <div className={classes.about}>
          <div className={classes.details}>
            ...
            <h2 className={classes.heading1}>  EXERGIE- 2023</h2>
            <p className={classes.para}>
            EXERGIE'23 is a technical festival offering a diverse range of events
              ...
              extravaganza of the year 2k23 – EXERGIE'23!
            </p>
